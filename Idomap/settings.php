...
<body>
	...
	<div class="contentbox one-edge-shadow settingPage">
		<div class="links"><a href="#settings1" id="settinglink1">Account Settings</a> | <a href="#settings2" id="settinglink2">Photo Options</a> | <a href="#other" id="settinglink3">Link 3</a></div>
		<br/><br/>
